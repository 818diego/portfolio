                ...
                >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 overflow-hidden transition-all duration-700 ease-in-out opacity-100">
                        {exp.achievements.map((achievement: any, i: number) => (
                            <div
                                key={i}
                                className="flex items-center px-3 py-2 rounded-lg bg-white/5 dark:bg-white/5 text-gray-700 dark:text-zinc-100/90 border border-white/10 dark:border-white/10 transition-all duration-300"
                            >
