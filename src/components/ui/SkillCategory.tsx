...
const SkillCategory: React.FC<{
  ...
  return (
    <div
      ref={categoryRef}
      data-skill-category
      className={`bg-zinc-800 rounded-xl p-4 md:p-5 shadow-sm border border-zinc-700/50 ${className}`}
    >
      <h3 data-cat-title className="text-base font-bold mb-3 text-white">
        {title}
      </h3>
