...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    ...
    >
      <div data-pc className="relative h-56 overflow-hidden">
        <img
          src={project.image}
          alt={project.title}
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3
          data-pc
          className="text-lg font-bold mb-2 text-white group-hover:text-green-400"
        >
          {project.title}
        </h3>
        ...
        {project.demo && (
          <div
            data-pc
            className="mt-auto pt-5 border-t border-zinc-700/50 flex justify-end"
          >
            <a
              href={project.demo}
              target="_blank"
